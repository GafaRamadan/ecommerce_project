          ...
          <div class="container p-0">
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                ?>
                <li class="mb-2"><a class="reset-anchor" href="?catid=<?= $cat['id'] ?>"><?= $cat['name'] ?></a></li>
                  <?php 
    endforeach;
                  ?>
                </ul>
              ...
              <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                ...
                <div class="row">
                  ...
                  $startLimit = 7;
                  $thisPgae = ($page - 1) * $startLimit;

              if (!isset($_GET['catid'])) {
                 $selpro = "SELECT * FROM product LIMIT $thisPgae, $startLimit";
              }   else{
                $catId = $_GET['catid'];
                $selpro = "SELECT * FROM product WHERE cat_id = $catId LIMIT $thisPgae, $startLimit";
...
foreach ($queryPro as $product) {
         ...
         $Img = "SELECT * FROM images WHERE product_id = $productId";
         $queryImg = $conn -> query($Img);
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white badge-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="admin/images/<?= $All[$count]?>" alt="..."></a>
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline">
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="Add_to_cart.php?id=<?= $product['id']?>">Add to cart</a></li>
...
<?php } ?>
    ...
    ?>
       ...
       <?php
                  ...
                  <?php 
                  $Allpro = "SELECT * FROM product";
                  $AllQuery = $conn -> query($Allpro);
                  $num = $AllQuery-> num_rows;
                  $total = ceil($num / $startLimit);
