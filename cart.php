                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    // select cart
                      ...
                      $querycart = $conn ->query($cart);
                      foreach ($querycart as $viewCart) {

                          // select product
                           $id_product = $viewCart['pro_id'];
                          $sql = "SELECT * FROM product WHERE id = $id_product";
                          $queryPro = $conn -> query($sql);
                          $result = $queryPro->fetch_assoc();
                      // select image
                          $Img = "SELECT * FROM images WHERE product_id = $id_product";
          ...
          ?>
                    ...
                    <tr>
                      <th class="pl-0 border-0" scope="row">
                        <div class="media align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.php"><img src="admin/images/<?= $img_name?>" alt="..." width="70"/></a>
                          <div class="media-body ml-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.php"><?= $result ['name'] ?></a></strong></div>
                        </div>
                      </th>
                      <td class="align-middle border-0">
                        <p class="mb-0 small">$<?= $result ['price'] ?></p>
                      </td>
                      <td class="align-middle border-0">
